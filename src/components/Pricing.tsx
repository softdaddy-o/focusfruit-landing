...
const PLANS = [
  ...
  },
  {
    ...
    alternativePrices: [
      ...
      { label: '$99 lifetime', savings: 'Best value', isTimeSale: false },
    ],
    description: 'The complete focus habit system — blocking, tracking, and explanations',
    features: [
      'Everything in Free, plus:',
      'Website blocking during focus',
      'Smart Pause with interruption logging',
      'Mood & energy tracking',
      'Weekly & monthly analytics with explanations',
      'Custom tag management',
      'SwitchBot smart home integration',
    ],
